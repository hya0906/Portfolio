...
with tf.device('/device:GPU:0'):
    ...
    length = 84351
    num = 39
    # PATH = "C:\\Users\\711_2\\Desktop\\Yuna_Hong\\speech_expression\\WAV2MFCC\\WAV2VEC\\distillation_231006\\RAVDESS"
    PATH = "C:\\Users\\711_2\\Desktop\\Yuna_Hong\\speech_expression\\WAV2MFCC\\WAV2VEC\\new_data\\CREMA_noaug_wav_16000_84351"
    ...
    for idx, wav_file in enumerate(WAV_PATH):
        emo = wav_file.split("_")[2]
        actor = wav_file.split("_")[0]
        #if actor not in actors_per_fold[0]:
        label = [0 for i in range(7)]
        label[dict_emotions_crema[emo]] = float(1)
    ...
    name1 = "CREMA_all_noaug_MFCC_train_84351_7"
    ...
    #         labels.append(label)
    #
    #         feature = get_mfcc_feature(wav_file, sr=sr, mean_signal_length=length, test=False)
    #         features.append(feature)
    #
    #     if (idx + 1) % 100 == 0:
    #         print("idx: ", idx + 1)
    ...
    #
    # name2 = "CREMA_augMFCC_test_84351_7"
