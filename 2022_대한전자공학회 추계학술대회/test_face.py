...
detector = insightface.model_zoo.get_model('C:/Users/711_2/Desktop\홍윤아\대학교코드\lab_test\datadet_10g.onnx')  # retinaface
detector.prepare(ctx_id=0, det_size=(640, 640))

ort_model = onnxruntime.InferenceSession('C:/Users/711_2\Desktop\홍윤아\대학교코드\lab_test\datalab_test\data\model_12.onnx')
...
def who_are_you(pic):  # 일단 한명예측
    ...
    if res[0][0][np.argmax(res)] > 0.97: #정확도가 0.97이상이면 해당 사람으로 인식
