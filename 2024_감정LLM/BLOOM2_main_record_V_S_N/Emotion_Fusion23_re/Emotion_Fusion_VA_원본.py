...
class VideoRecorder():
    ...
    def __init__(self, camindex=0, fps=30):
...
class AudioRecorder():
    ...
    def __init__(self, rate=16000, fpb=2**10, channels=1, audio_index=0):
        self.open = True
        self.rate = rate
                        ...
                        try:
                            ...
                            with korean_audio as source:
                                ...
                                try:
                                    ...
                                    print('음성변환 : ' + r.recognize_google(recorded_audio, language='ko-KR'))
