...
sys.path.insert(0, "C:\\Users\\yuna\\Desktop\\emotion_version\\BLOOM2_main_record_V_S_N\\Emotion_Fusion23_re")
# sys.path.append(os.path.dirname(os.path.abspath(os.path.dirname(__file__))))
os.chdir('C:\\Users\\yuna\\Desktop\\emotion_version\\BLOOM2_main_record_V_S_N\\Emotion_Fusion23_re')
print(sys.path)
