...
# file_name = "Emotion_Fusion23_re\\SER_model\\wav2vec2-large-xlsr-53-english.quant_static.onnx"
file_name = ".\\SER_model\\wav2vec2-large-xlsr-53-english.quant_static.onnx"
# print("###",os.getcwd())
# print(os.listdir(os.path.join(os.getcwd(), "SER_model")))
...
# onnx_model_name = "C:\\Users\\yuna\\Desktop\\BLOOM2-main\\BLOOM2_main\\Emotion_Fusion23_re\\VER_model\\MobileNetV2_Demo.onnx"
onnx_model_name = ".\\VER_model\\MBv2_RAF_AFF_GPU.onnx"
# print("!",os.path.join(os.getcwd(), onnx_model_name))
...
# Face Detection
detector = SCRFD(model_file='C:\\Users\\yuna\\Desktop\\emotion_version\\BLOOM2_main_record_S_N\\Emotion_Fusion23_re\\FD_model\\scrfd_500m_bnkps.onnx')
