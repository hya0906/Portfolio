...
os.chdir('C:\\Users\\yuna\\Desktop\\emotion_version\\BLOOM2_main_original_onlyllm')
...
def main():
    ...
    ### 13B
    # llm = Llama(model_path="C:\\Users\\yuna\\Desktop\\BLOOM2-main\\BLOOM2_main\\mldata\\llama-2-13b-chat.Q5_K_M.gguf", verbose=False,
    #             n_ctx=2048, n_batch=1024, n_gpu_layers=100)
