...
def hand_drawing(image, results, gesture, action, left_hand, right_hand):
    global tmp_act, s_flag, before_dnum, dial_flag,dn
    ...
    for hand_index in range(c):
        ...
        #     s_flag = True
        elif dial_flag == True and dn != dial_num[hand_label.upper()]:
            s_flag = True

        #print(dn, "!=", dial_num[hand_label.upper()])
        dn = dial_num[hand_label.upper()]

        #print(dial_num, dial_num[hand_label.upper()])
        # if s_flag == True:
        ...
        if s_flag == True:
            ...
            print("thread", gesture[hand_label.upper()], speak, temp, action_last[hand_label.upper()])
            s = Thread(target=act_sound, args=(gesture[hand_label.upper()], speak[hand_label.upper()], temp))
            s.start()
